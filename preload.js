...
const inventoryApi = {
  ...
  getVendors: (payload) => ipcRenderer.invoke('vendors:getAll', payload),
  createVendor: (payload) => ipcRenderer.invoke('vendors:create', payload),
  getExpenseCategories: () => ipcRenderer.invoke('expenses:categories:getAll'),
  createExpenseCategory: (payload) => ipcRenderer.invoke('expenses:categories:create', payload),
  getExpenses: (payload) => ipcRenderer.invoke('expenses:getAll', payload),
  createExpense: (payload) => ipcRenderer.invoke('expenses:create', payload),
  getIncomeCategories: () => ipcRenderer.invoke('income:categories:getAll'),
  createIncomeCategory: (payload) => ipcRenderer.invoke('income:categories:create', payload),
  getIncome: (payload) => ipcRenderer.invoke('income:getAll', payload),
  createIncome: (payload) => ipcRenderer.invoke('income:create', payload),
  getCashflowTransactions: (payload) => ipcRenderer.invoke('cashflow:transactions:getAll', payload),
  ...
  getExpenseReport: (payload) => ipcRenderer.invoke('reports:getExpenses', payload),
  getIncomeReport: (payload) => ipcRenderer.invoke('reports:getIncome', payload),
  getCashflowReport: (payload) => ipcRenderer.invoke('reports:getCashflow', payload),
  getRevenueReport: (payload) => ipcRenderer.invoke('reports:getRevenue', payload),
  getCombinedFinancialReport: (payload) => ipcRenderer.invoke('reports:getCombinedFinancial', payload),
